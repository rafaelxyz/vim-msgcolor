...
" end of message systax


"syntax keyword trace CAMP PROC STEP RAF
syntax match trace 'CAMP\|PROC\|STEP\|RAF'
syntax match errmsg1 '\cERROR\|FAIL'
syntax keyword errmsg2 ER

hi trace ctermbg=2 ctermfg=0
"hi def link trace Special

hi def link errmsg1 ErrorMsg
hi def link errmsg2 ErrorMsg
